...
const TrueWarranty = () => {
  ...
  return (
    <Layout>
      ...
      <section className="relative min-h-[80vh] md:min-h-screen flex items-center justify-center overflow-hidden bg-white">
        ...
        <div className="max-w-5xl mx-auto px-6 md:px-8 text-center relative z-10 py-16 md:py-32">
          <div className="space-y-8 md:space-y-12 animate-fade-up">
            <h1 className="font-display text-5xl sm:text-6xl md:text-8xl lg:text-9xl font-extralight text-foreground leading-[0.9] tracking-tight">
              Not a number.<br />A promise.
            </h1>
            
            <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-light text-muted-foreground max-w-2xl mx-auto leading-relaxed mt-8 md:mt-16">
        ...
        <div className="max-w-5xl mx-auto px-6 md:px-8">
          <div className="text-center space-y-8 md:space-y-16">
            <div className="space-y-6 md:space-y-12">
              <blockquote className="font-display text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-extralight text-foreground leading-tight">
      ...
      <section className="py-16 md:py-32 lg:py-40 bg-muted/10">
        <div className="max-w-6xl mx-auto px-6 md:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
            ...
            {/* Market Card */}
            <div className="bg-card rounded-2xl p-6 sm:p-8 md:p-12 shadow-sm border border-border">
              <div className="space-y-6 md:space-y-8">
                <h3 className="text-2xl sm:text-3xl font-semibold text-foreground mb-6 md:mb-12">Market Standard</h3>
            ...
            {/* NESS Card */}
            <div className="bg-card rounded-2xl p-6 sm:p-8 md:p-12 shadow-sm border-2 border-energy">
              <div className="space-y-6 md:space-y-8">
                ...
                <div className="space-y-4 md:space-y-6">
                  <div className="flex items-start space-x-3 md:space-x-4 pb-4 md:pb-6 border-b border-border">
                    ...
                    <div>
                      <p className="font-medium text-foreground text-sm md:text-base">After 5 Years</p>
                      <p className="text-muted-foreground mt-1 text-sm md:text-base">Full replacement coverage</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3 md:space-x-4 pb-4 md:pb-6 border-b border-border">
                    ...
                    <div>
                      <p className="font-medium text-foreground text-sm md:text-base">Test Conditions</p>
                      <p className="text-muted-foreground mt-1 text-sm md:text-base">Real-world heat, real loads</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3 md:space-x-4 pb-4 md:pb-6 border-b border-border">
                    ...
                    <div>
                      <p className="font-medium text-foreground text-sm md:text-base">Fine Print</p>
                      <p className="text-muted-foreground mt-1 text-sm md:text-base">Transparent, plain-language terms</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3 md:space-x-4 pb-4 md:pb-6 border-b border-border">
                    ...
                    <div>
                      <p className="font-medium text-foreground text-sm md:text-base">Support</p>
                      <p className="text-muted-foreground mt-1 text-sm md:text-base">Proactive monitoring + predictive care</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3 md:space-x-4 pb-4 md:pb-6 border-b border-border">
                    ...
                    <div>
                      <p className="font-medium text-foreground text-sm md:text-base">Accountability</p>
                      <p className="text-muted-foreground mt-1 text-sm md:text-base">We stand with you</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3 md:space-x-4">
                    ...
                    <div>
                      <p className="font-medium text-foreground text-sm md:text-base">Value</p>
                      <p className="text-muted-foreground mt-1 text-sm md:text-base">Peace of mind, guaranteed</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="py-16 md:py-32 lg:py-40 bg-white">
        <div className="max-w-4xl mx-auto px-6 md:px-8">
          <div className="text-center space-y-12 md:space-y-16">
            <h2 className="font-display text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extralight text-foreground leading-tight">
              Built for your world.
            </h2>
            
            <div className="space-y-4 md:space-y-6 text-lg sm:text-xl md:text-2xl font-light text-muted-foreground max-w-2xl mx-auto">
      ...
      <section id="warranty-terms" className="py-16 md:py-32 lg:py-40 bg-foreground text-background">
        <div className="max-w-5xl mx-auto px-6 md:px-8 text-center">
          <div className="space-y-12 md:space-y-20">
            <h2 className="font-display text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-extralight leading-tight">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-4 sm:gap-6 pt-4 md:pt-8">
              ...
              <Button 
                asChild
                variant="outline" 
                className="border-background/30 text-background hover:bg-background/10 hover:text-background px-8 sm:px-12 py-4 sm:py-6 text-base sm:text-lg rounded-xl transition-all duration-300 w-full sm:w-auto"
              >
